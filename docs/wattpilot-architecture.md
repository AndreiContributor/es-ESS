...
- Exact Venus OS compatibility (`v3.73` or `v3.75`) before the application
...
- Venus OS must match an explicitly supported clean release (`v3.73` or
  `v3.75`) before es-ESS starts any service or grid-setpoint side effect.
